...
BOOST_AUTO_TEST_CASE( test_all_point_point )
{
    ...
    test_distance_point_point(pp_strategy);
    test_distance_point_point(ps_strategy);
}
...
BOOST_AUTO_TEST_CASE( test_all_empty_input_pointlike_pointlike )
{
    ...
    test_more_empty_input_pointlike_pointlike<point_type>(pp_strategy);
    test_more_empty_input_pointlike_pointlike<point_type>(ps_strategy);
}
