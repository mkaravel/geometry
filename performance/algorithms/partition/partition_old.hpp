...
#ifndef BOOST_GEOMETRY_ALGORITHMS_DETAIL_PARTITION_OLD_HPP
#define BOOST_GEOMETRY_ALGORITHMS_DETAIL_PARTITION_OLD_HPP
...
<
    ...
    typename IncludePolicy1 = detail::partition::old::include_all_policy,
    typename IncludePolicy2 = detail::partition::old::include_all_policy,
    typename VisitBoxPolicy = detail::partition::old::visit_no_policy
>
class partition_old
{
    typedef std::vector<std::size_t> index_vector_type;
...
public :
    ...
    static inline void apply(InputCollection const& collection,
            ...
            VisitBoxPolicy box_visitor = detail::partition::old::visit_no_policy()
            )
    {
        if (std::size_t(boost::size(collection)) > min_elements)
        {
            ...
            detail::partition::old::partition_one_collection
                <
                    0, Box,
                    OverlapsPolicy1,
                    ExpandPolicy1,
                ...
                )
    {
            ...
            && std::size_t(boost::size(collection2)) > min_elements)
        {
            ...
            detail::partition::old::partition_two_collections
                <
...
#endif // BOOST_GEOMETRY_ALGORITHMS_DETAIL_PARTITION_OLD_HPP
