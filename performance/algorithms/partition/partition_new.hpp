...
#ifndef BOOST_GEOMETRY_ALGORITHMS_DETAIL_PARTITION_NEW_HPP
#define BOOST_GEOMETRY_ALGORITHMS_DETAIL_PARTITION_NEW_HPP
...
<
    ...
    typename IncludePolicy1 = detail::partition::new_::include_all_policy,
    typename IncludePolicy2 = detail::partition::new_::include_all_policy,
    typename VisitBoxPolicy = detail::partition::new_::visit_no_policy
>
class partition_new
{
    template
...
public :
    ...
    static inline void apply(ForwardRange const& forward_range,
            ...
            VisitBoxPolicy box_visitor = detail::partition::new_::visit_no_policy()
            )
    {
        typedef typename boost::range_iterator
            <
        ...
        if (std::size_t(boost::size(forward_range)) > min_elements)
        {
            ...
            detail::partition::new_::partition_one_range
                <
                    0, Box,
                    OverlapsPolicy1,
                    ExpandPolicy1,
    ...
    static inline void apply(ForwardRange1 const& forward_range1,
                ...
                VisitBoxPolicy box_visitor
                   = detail::partition::new_::visit_no_policy()
                )
    {
        typedef typename boost::range_iterator
            <
            ...
            && std::size_t(boost::size(forward_range2)) > min_elements)
        {
            ...
            detail::partition::new_::partition_two_ranges
                <
...
#endif // BOOST_GEOMETRY_ALGORITHMS_DETAIL_PARTITION_NEW_HPP
